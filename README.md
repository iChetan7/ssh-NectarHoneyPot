# Nectar — SSH & HTTP Honeypot

> A cybersecurity honeypot system that traps attackers in a fake server, silently logs every move, and streams it all to a live real-time dashboard.

<p align="center">
  <img src="https://img.shields.io/badge/Python-3.8+-blue?style=for-the-badge&logo=python" alt="Python 3.8+">
  <img src="https://img.shields.io/badge/Flask-3.0.0-black?style=for-the-badge&logo=flask" alt="Flask 3.0.0">
  <img src="https://img.shields.io/badge/Paramiko-3.4.0-orange?style=for-the-badge" alt="Paramiko 3.4.0">
...
**Nectar** is a Python-based honeypot system built as a 3rd Year CSE Cybersecurity project. It creates two fake servers — an SSH server and an HTTP admin website — that look real to an attacker. When an attacker connects and tries to break in, every single action is silently captured and stored. A live web dashboard shows all attack events in real time, including:

- Attacker's IP address
- Passwords they tried
- Commands they ran
- Geographic location
...
| Password | Result | Dashboard |
|---|---|---|
| `wrongpass` | **FAILED** | Logged |
| `123456` | **FAILED** | Logged |
| `password` | **SUCCESS** | Bait accepted — fake shell opens |
...
- Run inside a **controlled local network** — not on the public internet
